...
Cheatsheet pdf[在此](https://github.com/scateu/tsv_edl.vim/raw/main/docs/tsv_edl_refcard.pdf)，demo在这里。
...
![work flow](https://github.com/scateu/tsv_edl.vim/raw/main/docs/tsv_edl_flow.png)
