...
======
  ...
  - [Linus Torvalds](http://yarchive.net/comp/linux/stupid_mail_clients.html)
    - 在LKML里: 1998-07-10  ~  2019-01-19
      - 共发23956封邮件, 其中13042封邮件是用PINE/Alpine写的(通过Message-ID看到的)
      - PINE: 7510,  1998-07-10 ~ 2007-04-16
      - Alpine: 5532, 2007-04-18 ~ 2018-07-11 [例](https://lore.kernel.org/lkml/alpine.LFD.2.21.999.1807102011380.30072@i7.lan/)
