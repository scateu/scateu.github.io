...
====
  ...
  - <del>不支持通过外部 IMAP 同步工具如 offlineimap 或 mbsync , 但貌似有人可以实现, 目前我没有跟进此事</del> 已经支持Maildir, 见[Maildir Patch](http://patches.freeiz.com/alpine/patches/alpine-2.20/maildir.patch.gz)及[Example](https://github.com/scateu/alpine-patches/blob/master/examples/maildir.pinerc)
...
========
  ...
  - [Eduardo Chappa 的帮助](http://patches.freeiz.com/alpine/alpine-info/)
  - Eduardo Chappa 的 Alpine Patches 页面 <http://patches.freeiz.com/alpine/>
