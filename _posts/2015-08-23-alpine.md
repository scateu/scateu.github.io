...
======
  ...
  - [Linus Torvalds](http://yarchive.net/comp/linux/stupid_mail_clients.html) 从1998年中到2018年末, 在[LKML](https://www.kernel.org/lore.html)里总共发的[23956封邮件](https://lore.kernel.org/lkml/?q=f%3ATorvalds)中, 13042封邮件是用PINE/Alpine写的(通过[Message-ID看到](https://lore.kernel.org/lkml/alpine.LFD.2.21.999.1807102011380.30072@i7.lan/)的)
