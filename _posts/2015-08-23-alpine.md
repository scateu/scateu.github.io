...
======
  ...
  - [Linus Torvalds](http://yarchive.net/comp/linux/stupid_mail_clients.html) 从1998-07-10 ~ 2019-01-19,在[LKML](https://www.kernel.org/lore.html)里, 共[发23956封邮件](https://lore.kernel.org/lkml/?q=f%3ATorvalds), 其中13042封邮件是用PINE/Alpine写的(通过[Message-ID看到](https://lore.kernel.org/lkml/alpine.LFD.2.21.999.1807102011380.30072@i7.lan/)的)
