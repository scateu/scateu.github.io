...
详见:<http://todotxt.com/>
 ...
 - Linux:
   ...
   - `sudo pip install todotxt-machine` [^†] 非常漂亮，除了不支持中文搜索，但是对中文的Context支持没问题
 ...
 - Chrome: [Todo.txt Chrome App](https://chrome.google.com/webstore/detail/ohjgbfjncbnecbnijmpgjhodnhbhnjgk) [^†]
 - emacs: [todotxtel](https://killring.org/todotxtel/)
 - Windows: [todotxt.net](http://benrhughes.com/todotxt.net/)
 - vim: [todo.txt-vim](https://github.com/freitass/todo.txt-vim) [^†]
