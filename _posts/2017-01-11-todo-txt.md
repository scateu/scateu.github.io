...
```
alias t-focus="t |grep -v -e @movie -e @home -e @waiting -e @someday -e @buy"
```
...
另外，Todo.txt也支持一些[插件](https://github.com/ginatrapani/todo.txt-cli/wiki/Todo.sh-Add-on-Directory)，推荐试一试schedule插件。
